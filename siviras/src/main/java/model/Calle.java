...
public class Calle implements Serializable {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((callCalle == null) ? 0 : callCalle.hashCode());
		result = prime * result + ((callIdCalle == null) ? 0 : callIdCalle.hashCode());
		result = prime * result + ((direcciones1 == null) ? 0 : direcciones1.hashCode());
		result = prime * result + ((direcciones2 == null) ? 0 : direcciones2.hashCode());
		result = prime * result + ((direcciones3 == null) ? 0 : direcciones3.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (callCalle == null) {
			if (other.callCalle != null)
				return false;
		} else if (!callCalle.equals(other.callCalle))
			return false;
		if (callIdCalle == null) {
			...
			return false;
		if (direcciones1 == null) {
			if (other.direcciones1 != null)
				return false;
		} else if (!direcciones1.equals(other.direcciones1))
			return false;
		if (direcciones2 == null) {
			if (other.direcciones2 != null)
				return false;
		} else if (!direcciones2.equals(other.direcciones2))
			return false;
		if (direcciones3 == null) {
			if (other.direcciones3 != null)
				return false;
		} else if (!direcciones3.equals(other.direcciones3))
			return false;
		return true;
	}
